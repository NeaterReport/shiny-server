...
# Import data
waitTime_prov_df <- read_excel("CIHI treatment wait time.xlsx", "To R Prov")
...
Reports are created on the fly based on the province you selected on the dashboard. Right now, you are reading a provincial report on treatment wait time for `r input$ui_prov`, which shows the 50th Percentile wait time for `r input$ui_trt` in 2014 is `r wait_50`.
...
```{r echo=FALSE, warning = FALSE, fig.height = 7.5, fig.align='center'}
...
```{r echo=FALSE, warning = FALSE, fig.height = 7.5, fig.align='center', message=FALSE}
